...
case "$(basename "${SHELL}")" in
    [Ss][Hh]) if [[ test -f "${HOME}/.dotfiles/sh_profile" ]]; then . "${HOME}/.dotfiles/sh_profile"; fi ;;
    [Bb][Aa][Ss][Hh]) if [[ test -f "${HOME}/.dotfiles/bash_profile" ]]; then . "${HOME}/.dotfiles/bash_profile"; fi ;;
esac
